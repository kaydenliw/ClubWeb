...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Track all activities and changes across all organizations</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-100 p-4">
        <form method="GET" action="{{ route('admin.activity-logs.index') }}" class="grid grid-cols-1 md:grid-cols-5 gap-4">
            ...
            <div>
                ...
                <select name="organization_id" class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
            ...
            <div class="md:col-span-5 flex gap-3">
                ...
                @if(request()->hasAny(['action', 'organization_id', 'user_id', 'start_date', 'end_date']))
                <a href="{{ route('admin.activity-logs.index') }}" class="px-4 py-2 text-sm text-gray-600 hover:text-gray-900 transition">
                    Clear Filters
                </a>
                @endif
            </div>
            ...
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-4 py-3">
                            <div class="text-sm font-medium text-gray-900">{{ $log->organization->name ?? '-' }}</div>
                        </td>
                        <td class="px-4 py-3">
